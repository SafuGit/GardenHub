...
const UserCard = () => {
  ...
  return ( 
    <div className='bg-base-200 p-4 rounded-xl shadow-lg flex gap-4 sm:w-fit w-full sm:col-span-2 col-span-3'>
      <div className='h-full text-7xl'>
        <CgProfile></CgProfile>
      </div>
      <div className='text-md'>
        <h1 className='flex gap-2 items-center'><FaUser></FaUser> {user.displayName}</h1>
        <h1 className='flex gap-2 items-center truncate flex-wrap'><MdMail></MdMail> @{user.email}</h1>
