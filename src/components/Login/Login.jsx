...
const Login = () => {
  const { signInWithEmail, signInWithGoogle, setUser } = use(AuthContext);
    ...
    <div className='w-full mx-auto flex justify-center'>
      <form onSubmit={handleSignUp}>
        <fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-xs border p-4">
          ...
          <button className="btn btn-neutral mt-4 mb-2" type='submit'>Login</button>
          ...
          <Link to={'/register'} className='underline mt-2 text-white'>Dont have an account?</Link>
        </fieldset>
      </form>
    </div>
  );
